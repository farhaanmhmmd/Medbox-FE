  ...
  [1868],
  {
    ...
    57234: function (a, b, c) {
      ...
      b.default = function () {
                  ...
                  for (;;)
                    switch ((a.prev = a.next)) {
                      ...
                      case 3:
                        return (
                          (a.next = 5),
                          k.default.post("/users/sendResetPasswordMail", {
                            email: c,
                          })
                        );
                      case 5:
                      ...
                      case 9:
                        (a.prev = 9),
                          ...
                          p({
                            ...
                            description: (
                              null === (b = a.t0.response.data) || void 0 === b
                                ? void 0
                                : b.message
                            )
        ...
        return (0, g.jsxs)("div", {
          className:
            "w-[100vw] h-[100vh] flex items-center justify-center flex-col",
          children: [
            (0, g.jsx)("div", {
            ...
            (0, g.jsxs)("div", {
              ...
              children: [
                ...
                (0, g.jsx)("p", {children: "Please enter your email"}),
                (0, g.jsx)("div", {
                  id: "mobile-input",
                  className:
                    "bg-white w-[90%] desktop:hidden my-[3vh] rounded-[3vw]",
                  children: (0, g.jsx)(i.II, {
                    size: "md",
                    variant: "filled",
                ...
                (0, g.jsx)("div", {
                  id: "desktop-input",
                  className:
                    "bg-white desktop:inline hidden w-[50%] my-[3vh] rounded-[3vw]",
                  children: (0, g.jsx)(i.II, {
                    size: "lg",
                    variant: "filled",
                    placeholder: "Your Email",
